...
<title>{title}</title>
<style>
body{{margin:0;font-family:system-ui,sans-serif;background:#111827;color:#f9fafb;line-height:1.6}}
main{{max-width:820px;margin:0 auto;padding:2.5rem 1.25rem}}
.notice{{background:#1f2937;border:1px solid #374151;color:#d1d5db;padding:1rem;border-radius:8px;margin:1rem 0}}
.links a{{display:inline-block;margin:.35rem .75rem .35rem 0;color:#fbbf24;font-weight:600}}
ol{{padding-left:1.25rem}} code{{background:#374151;padding:.1rem .35rem;border-radius:4px}}
